...
def run():
    ...
    run_config.driver_type_density = [0.05, 0.10, 0.15, 0.30, 0.40]
    ...
    with open('runs/run_14/txt/time_taken.txt', 'w+') as f:
    ...
    for i in range(0, len(results)):
        for j in range(0, len(results[i])):
            ...
            Stats.append_simulation_results_to_file(
                sim_results, f'runs/run_14/txt/results_{i}.txt',
                j
            )
    ...
    for i in range(0, len(medians)):
        ...
        graphics.plot_avg_time_and_accidents(
            median, f'runs/run_14/img/avg_time_and_accidents_{i}.png',
